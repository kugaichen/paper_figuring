...
# # Evaluation2: data 
Evaluation2_method1 = np.array([8, 9, 7, 8, 5, 6, 4, 10, 9])        
Evaluation2_method2 = np.array([8, 10, 11, 9, 7, 12, 13, 11, 9])       
Evaluation2_method3 = np.array([10, 12, 8, 9, 7, 11, 12, 10, 10])        
Evaluation2_method4 = np.array([11, 13, 11, 12, 13, 12, 13, 10, 14])     
Evaluation2_method5 = np.array([20, 18, 22, 15, 15, 15, 20, 20, 20])       
...
values1 = Evaluation2_method1      
values2 = Evaluation2_method2    
values3 = Evaluation2_method3
values4 = Evaluation2_method4
values5 = Evaluation2_method5 
...
max_value = max([max(values) for values in [values1, values2, values3, values4, values5] if len(values) > 0])
ax.set_ylim(min_value * 0.8, max_value * 1.1)  # 设置Y轴范围，上限为最大值的1.2倍
...
# 保存图片
output_dir = r".\result"
output_path = r".\result\Histogram_int_result.png"
